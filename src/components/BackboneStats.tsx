...
const STATS: BackboneStat[] = [
  {
    value: '6 Agents',
    label: 'collaborating autonomously across construction, permits, email, and accounting',
    color: '#533AFD',
    sparkline: [
      { t: 'Q1', v: 22.4 },
      { t: 'Q2', v: 28.5 },
  ...
  {
    value: '94.8%',
    label: 'of routine contractor emails categorized and drafted without manual input',
    color: '#057A55',
    sparkline: [
      { t: 'Stage 1', v: 1.0 },
      { t: 'Stage 2', v: 2.4 },
  ...
  {
    value: '-38%',
    label: 'reduction in project delays through proactive municipal permit tracking',
    color: '#D97706',
    domain: [97.5, 100],
    sparkline: [
      { t: 'W1', v: 98.1 },
  ...
  {
    value: '< 60 sec',
    label: 'average turnaround from contractor email to Monday.com task dispatch',
    color: '#0d9488',
    domain: [0, 52],
    sparkline: [
      { t: 'Run 1', v: 48.0 },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.025em] text-[var(--color-text-primary)]">
            The backbone of modern real estate & construction operations
          </h2>
          <p className="mt-2 text-base text-[#2E3C4E] dark:text-slate-300 leading-relaxed">
            Connected AI employees communicating across permits, contractors, email triage, and deal underwriting.
          </p>
        </div>
