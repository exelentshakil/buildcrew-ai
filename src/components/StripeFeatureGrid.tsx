...
const FEATURES: FeatureItem[] = [
  {
    id: 'services',
    icon: LayoutGrid,
    title: 'Operational discovery & design.',
    description: 'Walk through how your business operates, identify bottlenecks, and design the exact AI agent roles needed before writing a line of code.',
  ...
  },
  {
    id: 'certifications',
    icon: Users,
    title: 'Multi-agent communication mesh.',
    description: 'Connect agents so the permit agent notifies the PM agent, the invoice agent verifies insurance COIs, and the executive assistant summarizes it all.',
  ...
  },
  {
    ...
    description: 'Seamlessly connect Google Drive, Gmail, Monday.com, n8n, Make, and custom APIs into one cohesive operational cockpit.',
        ...
        <div className="max-w-3xl mb-10">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-[-0.02em] text-[var(--color-text-primary)]">
            ...
            <span className="text-[var(--color-text-secondary)] opacity-75 font-normal">
              Scale your real estate and construction business with intelligent AI agents managing the operational heavy lifting.
            </span>
          </h2>
        </div>
