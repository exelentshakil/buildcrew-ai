...
const INITIAL_LOGS: LogEntry[] = [
  ...
  },
  {
    ...
    stage: 'Ingestion',
    status: '200 OK',
    details: 'Received rough electrical completion notice for 44 Elm St. Verified COI insurance, scheduled municipal inspection, created Monday.com card (HTTP 200).',
    durationMs: 310,
  },
  {
    id: 'log_05',
