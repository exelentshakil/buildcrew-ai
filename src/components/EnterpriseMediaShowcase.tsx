...
export function EnterpriseMediaShowcase() {
  ...
  const toggleMute = () => {
    ...
    // 3 Bespoke Real Estate & Construction Multi-Agent Pillars
  const architecturalPillars = [
    {
      id: "pillar-mesh",
      tag: "Inter-Agent Mesh",
      title: "Specialized Roles Working Together",
      description: "Autonomous AI employees communicating across permit tracking, subcontractor follow-ups, daily summaries, and bookkeeping.",
    },
    {
      id: "pillar-email",
      tag: "Action Extraction",
      title: "Automated Email & Invoice Triage",
      description: "Ingests Gmail and Drive attachments, audits contractor COI insurance, and drafts context-aware replies ready for one-tap approval.",
    },
    {
      id: "pillar-monday",
      tag: "Monday.com & Cloud Sync",
      title: "Real-Time Project Coordination",
      description: "Synchronizes project management boards, updates milestone timelines, and tracks outstanding vendor deliverables automatically.",
    },
  ];
          ...
          <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] overflow-hidden shadow-2xs hover:shadow-xs transition-shadow mb-8">
            <div className="relative h-64 sm:h-80 w-full overflow-hidden bg-slate-900">
              ...
              <img
                ...
                alt="Real estate development and construction operations cockpit"
            ...
            <div className="p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              <div className="space-y-1 max-w-2xl">
                <div className="text-base sm:text-lg font-bold text-[var(--color-text-primary)]">
                  Construction & Real Estate Operations Automation
                </div>
                <p className="text-xs sm:text-sm text-[var(--color-text-secondary)] opacity-85 leading-relaxed">
                  Automated 120+ weekly contractor emails, permit checks, and invoice audits across 3 active jobsites.
                </p>
              </div>
